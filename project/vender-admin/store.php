...
<body>
    ...
    <section class="header">
      <div class="side-menu" id="side-menu">
          <ul>
              <li>On Sale<span class="glyphicon glyphicon-chevron-right"></span>
              <ul>
                  <li>Sub Menu-1</li>
                  <li>Sub Menu-1</li>
                  <li>Sub Menu-1</li>
               ...
               <li>Mobiles<span class="glyphicon glyphicon-chevron-right"></span>
                <ul>
                  <li>Sub Menu-2</li>
                  <li>Sub Menu-2</li>
                  <li>Sub Menu-2</li>
                ...
                <li> Computers<span class="glyphicon glyphicon-chevron-right"></span>
                 <ul>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
          ...
          <li>Bookes & Magazines<span class="glyphicon glyphicon-chevron-right"></span>
                 <ul>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
          ...
          <li>Fitness & Body Care<span class="glyphicon glyphicon-chevron-right"></span>
                 <ul>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
            ...
            <li>Auto Accessories<span class="glyphicon glyphicon-chevron-right"></span>
                 <ul>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
          ...
          <li>Movies & Music<span class="glyphicon glyphicon-chevron-right"></span>
                 <ul>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
          ...
          <li>Videos & Games<span class="glyphicon glyphicon-chevron-right"></span>
                 <ul>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
          ...
          <li>Home & Kitchen<span class="glyphicon glyphicon-chevron-right"></span>
                 <ul>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
          ...
          <li>Furniture<span class="glyphicon glyphicon-chevron-right"></span>
                 <ul>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
          ...
          <li>Grocery<span class="glyphicon glyphicon-chevron-right"></span>
                 <ul>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
                  <li>Sub Menu-3</li>
  ...
  $sql="SELECT * FROM `product` WHERE pcategory='Deal of the day' LIMIT 5";
   ...
   ?>
       ...
       <div class="title-box">
              ...
              <div class="side-btn">
              <a href="detailpdt1.php?type=Deal of the Day" class="btn btn-lg" id="myBtn" >
           View All</a>
         </div>
  <!-- Swiper -->
...
<section>
       <div class="title-box">
              ...
              <div class="side-btn">
              <a href="detailpdt2.php?type=cloth" class="btn btn-lg" id="myBtn" >View All</button></a>
           </div>
  <!-- Swiper -->
   <div class="swiper-container">
       <div class="swiper-wrapper">
...
if ($conn->connect_error) {
  ...
  <section>
       <div class="title-box">
              ...
              <div class="side-btn">
              <a href="detailpdt1.php?type=Luggegas" class="btn btn-lg" id="myBtn" >View All</button></a>
           </div>
  <!-- Swiper -->
  <div class="swiper-container">
       <div class="swiper-wrapper">
...
if ($conn->connect_error) {
 ...
 <section>
       <div class="title-box">
              ...
              <div class="side-btn">
              <a href="detailpdt1.php?type=Kitchen Product" class="btn btn-lg" id="myBtn" >View All</a>
           </div>
  <!-- Swiper -->
   <div class="swiper-container">
       <div class="swiper-wrapper">
   ...
   ?>
      <section>
       <div class="title-box">
              ...
              <div class="side-btn">
           <a href="detailpdt1.php?type=Kindle Book" class="btn btn-lg" id="myBtn" >View All</a>
