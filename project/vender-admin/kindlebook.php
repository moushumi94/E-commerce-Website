 ...
 <div class="col-sm-10">
     ...
     <div class="row">
     	<div class="col-sm-11" id="content1" >
     		<div class="listheading" style="padding-left: 35%;"><h3><b>KINDLE BOOK</b><h3></div>
	     <?php
//include "dbconn.php";
...
if ($conn->connect_error) {
  ...
  $sql="SELECT * FROM `product` WHERE pcategory='Kindle Book'";
   ...
   if($result->num_rows>0){
       ...
       echo  '<table class="table">
          ...
          <img src="image/'.$row["image"].'" class="img-rounded" height="60px" width="80px"> &nbsp;&nbsp;
          </td>
          <td>'.$row["ptitle"].'</td>
          <td>'.$row["price"].'</td>
          <td>'.$row["pQty"].'</td>
