 ...
 <div class="col-sm-10">
   	<div class="row">
            ...
            <li><a href="Today'sDeal.php">Today's Deal</a></li>
   					...
   					<li><a href="clothlist.php"> All Cloths</a></li>
     ...
     <div class="row">
     	<div class="col-sm-11" id="content1" >
     		<div class="listheading" style="padding-left: 35%;"><h3><b>Today's Deal</b><h3></div>
	     <?php
//include "dbconn.php";
...
if ($conn->connect_error) {
  ...
  $sql="SELECT * FROM `product` WHERE pcategory='Deal of the day'";
   ...
   if($result->num_rows>0){
      ...
      <td>'.$row["price"].'</td>
      <td>'.$row["pQty"].'</td>
      <td><a href="delete.php?id='.$row["id"].'"><button type="submit" class="btn btn-success">Delete</button></a></td>
             </tr>';
           }
             echo '</tbody>
         </table>';
