 ...
 <div class="col-sm-10" id="content">
     ...
     <div class="row">
     	<div class="col-sm-11" id="content1">
     		<div class="listheading" style="padding-left: 35%;"><h3><b>CLOTH LIST</b><h3></div>
	     <?php
//include "dbconn.php";
...
if ($conn->connect_error) {
  ...
  $sql="SELECT * FROM `product` WHERE pcategory='Cloth'";
   $result=$conn->query($sql);
   if($result->num_rows>0){

       echo  '<table class="table">
   				<thead><tr>
   			 <th>SL.no</th><th>IMAGE</th><th>NAME</th><th>PRICE</th><th>TOTAL</th><th><a class=" btn btn-primary" href="addproduct.php">Add New</a></th>
   				</tr>
   				</thead>
   				<tbody>';
